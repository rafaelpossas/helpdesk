 ...
 * http://github.com/brunotavares/Helpdesk.util.Router
 *
 ...
 */
Ext.define('Helpdesk.util.Router', {
    singleton: true,
    ...
    routeMatcher: function(app, route, rules) {
        ...
        if (!routeObj.controller && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[Helpdesk.util.Router] Config 'controller' can't be undefined", route, rules);
        }
    
        if (!routeObj.action && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[Helpdesk.util.Router] Config 'action' can't be undefined", route, rules);
        }
        //</debug>
    ...
    dispatch: function(token, route, params) {
        ...
        if (!controller[route.action] && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[Helpdesk.util.Router] Controller action not found ", route.controller, route.action);
            return false;
        }
        //</debug>
        ...
        if (!classMgr.get(controllerFullName)) {
            ...
            if (!classMgr.get(controllerFullName)) {
                ...
                if (Ext.isDefined(Ext.global.console)) {
                    Ext.global.console.warn("[Helpdesk.util.Router] Controller not found ", route.controller);
                }
                //</debug>
    ...
    Ext.override(Ext.app.Application, {
        ...
        onBeforeLaunch: function() {
            ...
            if(this.enableRouter){
                Helpdesk.util.Router.init(this);
            }
        }
    });
});